   ...
   <div className="flex w-full md:w-[600px] flex-col gap-2 items-start flex-shrink-0">
    <div className="flex flex-col justify-start">
     ...
     <motion.div
      initial={{ opacity: 0, y: 100 }}
      whileInView={{ opacity: 1, y: 0, transition: { duration: 0.4 } }}
      className="mt-3 border border-white rounded-xl  p-3"
     >
      <p className="text-[8px] sm:text-xs text-white font-regular text-justify">
     ...
     <motion.div
      ...
      className="mt-3 flex items-center gap-2 w-full mb-5"
     >
      <button
      ...
      >
       ...
       <span className="hidden md:block text-[8px] sm:text-xs text-white">
        {" "}
        resume
       </span>
      </button>
      ...
      <button className="md:w-full bg-gray-500 hover:bg-gray-700 bg-opacity-25 text-xs px-2 rounded-md h-10 border border-gray-400 border-opacity-40 flex items-center gap-3">
       <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
       ...
       <span className="hidden md:block text-[8px] sm:text-xs text-white shrink-0">
        Email at: trikk.dionen@gmail.com
       </span>
      </button>
     </motion.div>
    </div>
